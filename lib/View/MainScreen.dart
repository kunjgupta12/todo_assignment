...
import 'package:todo_assignment/models/FTodo.dart';
import 'package:todo_assignment/services/functions.service.dart';
import 'package:todo_assignment/utils/routes.dart';
import 'package:todo_assignment/utils/global.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:get/get.dart';
import 'package:todo_assignment/utils/widgets.dart';
import 'package:todo_assignment/view/ArrayScreen.dart';
import 'package:todo_assignment/view/DeleteScreen.dart';
import 'package:todo_assignment/view/HomeScreen.dart';
import 'package:todo_assignment/view/TodoScreen.dart';
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      filteredWidget(context, 'Urgent', 'No Urgent tasks',
                          arrayController.urgent, Icons.done_rounded),
                      filteredWidget(context, 'No So Urgent', 'No Urgent',
                          arrayController.allTodos, Icons.task)
                    ],
                  ),
                  const SizedBox(
...
class CustomSearchDelegate extends SearchDelegate {
  ...
  ThemeData appBarTheme(BuildContext context) {
    return ThemeData(
        scaffoldBackgroundColor: const Color.fromARGB(255, 89, 99, 104),
        ...
        inputDecorationTheme: const InputDecorationTheme(
            hintStyle: TextStyle(
                color: Color.fromARGB(255, 239, 235, 235), fontSize: 20.0),
